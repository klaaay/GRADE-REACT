  ...
  get_task_detail = async id => {
    ...
    try {
      const response = await fetch(
        "http://119.23.201.7:5001/teacher/detail",
        fetchOption
      );
      ...
      let GradeDoneTasks = body.data.filter(
        item =>
          item.teacherGradeDone && item.selfGradeDone && item.groupGradeDone
      );
      this.setState({
        loading: true,
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record) => {
          return text ? (
            <a target="_blank" href={"http://119.23.201.7:5001/" + record.word}>
      ...
      },
      {
        ...
        render: (text, record) => {
          return text ? (
            <a target="_blank" href={"http://119.23.201.7:5001/" + record.ppt}>
              <Icon type="file-ppt" theme={"twoTone"} />
            </a>
          ) : (
      ...
      },
      {
        ...
        render: (text, record) => {
          return text ? (
            <a target="_blank" href={"http://119.23.201.7:5001/" + record.video}>
      ...
      },
      {
        ...
        filterDropdown: ({
          ...
          <div className="custom-filter-dropdown">
            ...
            <Button
              ...
              onClick={() => {
                setSelectedKeys([" "]);
                setTimeout(this.handleSearch(selectedKeys, confirm), 0);
              }}
        ...
        render: (text, record) => {
          if (
            record.pptCommitted &&
            record.wordCommitted &&
            record.videoCommitted
          ) {
            return !text ? (
              <a
                onClick={e => {
          ...
          <TabPane tab="成绩详情" key="2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      this.setState(
                        ...
                        () => {
                          axios
                            .post("http://119.23.201.7:5001/teacher/detailChart", {
            ...
            <div className="score_cards">
              {this.state.Card ? (
                ...
                <div id="chartAll" style={{ margin: "0 auto" }} />
              )}
            </div>
          </TabPane>
